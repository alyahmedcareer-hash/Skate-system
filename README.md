...
|---|---|---|
| 00–12 | المراحل الأساسية والمكتملة (الزلاجات، العملاء، نقاط البيع والمصروفات) | ✅ مكتملة (CLOSED) |
| 13 | وحدة التقارير والتحليلات | ⏳ قيد التنفيذ (IN PROGRESS) |
| 14–18 | الوحدات المتبقية | 📋 مخططة (PLANNED) |
